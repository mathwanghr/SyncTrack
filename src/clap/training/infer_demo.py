...
def infer_text():
    ...
    fusion_type = 'aff_2d'
    pretrained = "/path/to/ckpt/fusion_best.pt" # the checkpoint name, the unfusion model can also be loaded.
...
def infer_audio():
    ...
    audio_waveform, sr = librosa.load('/path/to/ckpt/test_clap_short.wav', sr=48000) 
    # quantize
